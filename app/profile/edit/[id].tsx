...
export default function EditProfileScreen() {
  ...
  useEffect(() => {
    if (profile) {
      ...
      setCardColor(profile.cardColor || colors.cardColors[0]);
      setEmail(profile.contactInfo.email || '');
      setPhone(profile.contactInfo.phone || '');
      setCompany(profile.contactInfo.company || '');
      setPosition(profile.contactInfo.position || '');
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
      <Text style={styles.title}>Edit Your Digital Card</Text>
